...
class Annual_premium_travel_model EXTENDS CI_Model{
	...
	public function get_comparison($variant,$annual_premium,$age)
	{
		...
		policy_variants_master v,annual_premium_travel ap,policy_features_personal_accident f WHERE i.company_id=p.company_id AND p.policy_id=v.policy_id AND v.variant_id=ap.variant_id
