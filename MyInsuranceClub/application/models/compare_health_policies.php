...
class compare_health_policies EXTENDS CI_Model{
	...
	public function get_comparison($variant,$annual_premium,$age)
	{
		...
		$comparison="SELECT i.company_shortname,p.policy_name,v.variant_name,concat('Rs.',ap.annual_premium,'.00') as annual_premium,f.cashless_treatment,f.room_rent as 'Room Rent',f.icu_rent as 'Icu Rent',
