  ...
  <div id="highlighted "  class="" >
    <div class="container">
      <div class="col-md-12 center ">
        ...
        <h1 class="term_container" style="text-align:left; margin-top:30px;" id="step1">Compare & Buy Child Insurance Plans</h1>
        <div class="col-md-12 center">
    ...
    <div class="mic_c_chip" id="duration_other_select"><span></span> <a href="javascript:void(0)" class="fa fa-times close_duration_select"></a></div></div>
            ...
            <div class="mic_type">
              ...
              <div  style="margin-top:0px;" class="clearfix">
                ...
                <label  for="">Parent's Date of Birth</label>
               ...
               <label  for="">Child's Date of Birth</label>
                 ...
                 <input type="text" class="form-control child_dob_datepicker" name="dob" placeholder="DD-MM-YYYY" >
                </label>
                ...
                <div class="p_d_column " style="margin-top:0px;">
                   ...
                   <label  for="">Parent's Gender</label>
