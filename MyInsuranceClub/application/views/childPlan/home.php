  ...
  <div id="highlighted "  class="" >
    <div class="container">
      <div class="col-md-12 center ">
        ...
        <h1 class="term_container" style="text-align:left; margin-top:30px;" id="step1">Compare & Buy Child Plans</h1>
        <div class="col-md-12">
    ...
    <div class="mic_c_chip" id="duration_other_select"><span></span> <a href="javascript:void(0)" class="fa fa-times close_duration_select"></a></div></div>
            ...
            <div class="mic_type">
              <div class="form-lable">Policyholder Details</div>
                ...
                <label  for="Previous Insurer">Parent's Full Name</label>
                <input type="text" class="form-control" name="full_name" >
                </div>
                
                 <div class="p_d_column no_r">
                <label  for="Previous Insurer">Parent's Date of Birth</label>
                
                 <label style="position:relative; margin-bottom:0px;" class="input"> <i class="icon-append fa fa-calendar " id=""></i>
                 ...
                 <div class="p_d_column">
                   ...
                   <label  for="Previous Insurer">Parent's Gender</label>
               <div class="c_col_60" style="width:100%;  float:left; position:relative;">
                <div style="width:100%; margin-top:0px; line-height:0px;" class="mic_t_input">
                 ...
                 <div class="p_d_column no_r" >
               <label  for="Previous Insurer">Child's Date of Birth</label>
                
                 <label style="position:relative; margin-bottom:0px;" class="input"> <i class="icon-append fa fa-calendar " id="c_dob_datepicker"></i>
                 <input type="text" class="form-control dob_datepicker" name="c_dob" >
                </label>
                </div>
...
<script src="<?php echo base_url();?>/assets/js/child.js"></script>
