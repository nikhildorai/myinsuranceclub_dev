  ...
  <div id="highlighted "  class="" >
    <div class="container">
      <div class="col-md-12 center ">
        ...
        <div class="col-md-12 center">
          <p class="term_container sc_top" style="text-align:left; padding-top:0px; padding-bottom:10px; color:#ff6633;">Want the best pension plans? Get Started...</p>
        </div>
...
<script src="<?php echo base_url();?>/assets/js/pension.js"></script>
