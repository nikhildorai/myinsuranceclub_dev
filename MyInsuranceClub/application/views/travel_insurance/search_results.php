                					...
                					<?php if(!empty($sum_assured_array))
                	 					 {
                							sort($sum_assured_array);
												...
												{?>
                 									<div class="checkbox">
            											<label>
            												<input type="checkbox" id="coverage_amount" name="coverage_amount" value="<?php echo $sum;?>"  class="search_filter" <?php //echo $checked_roomrent;?>>
            													<label class="" for="coverage_amount"><?php echo 'USD '.number_format($sum) ;?></label>
          												</label>
          											</div>
											<?php }
										}?>
