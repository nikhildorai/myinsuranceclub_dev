<div id="highlighted" >
   <div class="container mar-20 ce">
      ...
      <div class="col-md-3">
         <img src="<?php echo base_url();?>/assets/images/lady.jpg" border="0">
         <h3 class="mar-30 fh1 mds">Start comparing. Start saving.</h3>
      </div>
      <div class="col-md-12 no_pad_l">
         <ul class="icon ipad" >
            <a href="javascript:void(0)">
               <li class="service box animated flipInY visible" data-animation="flipInY" data-animation-delay="0">
                  <strong class="service-logo prdt_spri1 img_cen"> </strong>
            ...
            <a href="javascript:void(0)">
               <li class="service box animated flipInY visible" data-animation="flipInY" data-animation-delay="200">
                  <strong class="service-logo prdt_spri1 img_cen1"> </strong>
            ...
            <a href="javascript:void(0)">
               <li class="service box animated flipInY visible" data-animation="flipInY" data-animation-delay="600">
                  <strong class="service-logo prdt_spri1 img_cen3"> </strong>
            ...
            <a href="javascript:void(0)">
               <li class="service box animated flipInY visible" data-animation="flipInY" data-animation-delay="800">
                  <strong class="service-logo prdt_spri1 img_cen4">  </strong>
            ...
            <a href="javascript:void(0)">
               <li class="service box animated flipInY visible" data-animation="flipInY" data-animation-delay="1000">
                  <strong class="service-logo prdt_spri1 img_cen5">  </strong>
            ...
            <a href="javascript:void(0)">
               <li class="service box animated flipInY visible" data-animation="flipInY" data-animation-delay="1200">
                  <strong class="service-logo prdt_spri1 img_cen6">  </strong>
            ...
            <a href="javascript:void(0)">
               <li class="service box animated flipInY visible" data-animation="flipInY" data-animation-delay="1400">
                  <strong class="service-logo prdt_spri1 img_cen7"></strong>
            ...
            <a href="javascript:void(0)">
               <li class="service lastl box animated flipInY visible" data-animation="flipInY" data-animation-delay="1600">
                  <strong class="service-logo prdt_spri1 img_cen8"> </strong>
         ...
         <li class="col-md-4">
            <div class="info">
               ...
               <div class="text orange-hover">By comparing plans with us you can save a large amount of money every year. <br>
                  <a href="javascript:void(0)" title="">Money saver</a> 
               </div>
            </div>
         </li>
         <li class="col-md-4">
            <div class="info">
               ...
               <div class="text orange-hover">In just a few seconds, we will display premiums from different insurance companies. <br>
                  <a href="javascript:void(0)" title="">Quick comparison </a> 
               </div>
            </div>
         </li>
         <li class="col-md-4">
            <div class="info">
               ...
               <div class="text orange-hover">We display premiums from all insurance companies partnered with us. No one is left out! <br>
                  <a href="javascript:void(0)" title="">Fair comparison</a> 
               </div>
            </div>
         </li>
      </ul>
                     ...
                     <div class="field-items">
                        <div class="field-item even">
                           <p><strong><img src="<?php echo base_url();?>/assets/images/left_t.jpg" border="0" class="top_i">&nbsp;&nbsp;Thank you once again for your free and very valuable information on 
                              insurance. Best wishes to your team and keep up the good work!&nbsp;&nbsp;</strong>
                           </p>
