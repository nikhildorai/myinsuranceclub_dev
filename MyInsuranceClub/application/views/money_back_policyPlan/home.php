...
<link rel="stylesheet" href="<?php echo base_url();?>/assets/css/term.css"><span id="o_touch"></span>
<div class="min_height1" style="height:auto; width:100%; ">
  <div id="highlighted "  class="" >
    <div class="container">
      <div class="col-md-12 center ">
        <div class="col-md-1"></div>
        <h1 class="term_container" style="text-align:left; margin-top:30px;  font-size: 44px;" id="step1">Compare & Buy Money Back Insurance Plans</h1>
        <div class="col-md-12 center">
        ...
        <div class="col-md-12 center">
          <p class="term_container sc_top" style="text-align:left; padding-top:0px; padding-bottom:10px; color:#ff6633;">Want the best money back insurance plan? Get Started...</p>
        </div>
  ...
  <div class="mic_c_custom">
    ...
    padding: 10px 20px;" class="btn btn-primary my">
          ...
          <div class=" mic_tooltip_column">
            <div style="top: 41.4833px;" class="mic_tooltip_message card">
...
<script src="<?php echo base_url();?>/assets/js/money-back-policy.js"></script>