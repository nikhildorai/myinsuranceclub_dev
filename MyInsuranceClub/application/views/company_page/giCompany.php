  ...
  <div class="container">
    <div class="row">
       ...
       <div class="col-md-12" style="padding-right:0px;">
        <h2 class="title-divider_h2"> <span>General Insurance Companies in India</span> </h2>
        <div class="company_abt">
        <h2 class="title-divider_h2_inn">There are <?php echo !empty($companyDetails) ? count($companyDetails) : '0';?> general insurance companies in India.</h2>
