...
<div class="col-md-9" style="padding-right: 0px;">
  <h2 class="title-divider"> <span><?php echo $companyDetails['company_name'];?> </span> </h2>
    ...
    <ul class="listsocial">
      ...
      <li class="reweet"><span id="ctl00_cphBody_lbltweet"><a
					...
					data-count='horizontal'>Tweet</a> <script type='text/javascript'
						src='http://platform.twitter.com/widgets.js'></script> </span> </li>
      <li class="last"><span id="ctl00_cphBody_ViewCount_lblViewsCount"> 17,083</span>&nbsp;Views</li>
    </ul>
  </div>
  <?php 
if (!empty($policies))
{		?>
  <div class="company_term">
    <h3 class="t_cmp_header"> <span>List of Plans from <?php echo $companyDetails['company_display_name'];?> </span> </h3>
...
?>
  ...
  <div class="company_abt">
    <h3 class="t_cmp_header"> <span><?php echo $companyDetails['heading_1'];?></span> </h3>
    <p class="mar-20">
      <?php 
...
?>
  ...
  <div class="company_abt">
    <h3 class="t_cmp_header"> <span><span><?php echo $companyDetails['heading_2'];?></span></span> </h3>
...
?>
      <img src="<?php echo $imgUrl;?>" class="round_image"> </p>
    <p align="center" style="width: 100%; float: left; text-align: center;"> <?php echo nl2br($companyDetails['description_2']);?> </p>
  </div>
  <?php }	?>
  <div class="company_abt">
    <h3 class="t_cmp_header"> <span>Contact Details</span> </h3>
    <div class="col-md-6 no_pad_l mar-20">
      <?php 					if (!empty($companyDetails['address']))	
						{	?>
      <address class="adr span6">
      <em class="fa fa-map-marker"></em> <strong class="t_h">Corporate Office</strong><br>
      <div class="road"> <?php echo nl2br($companyDetails['address']); ?> </div>
      <br>
      </address>
      <?php 					}	?>
      <div style="float: left; width: 100%; margin-top: 20px;">
        <?php 	if (!empty($companyDetails['twitter'])) { 	?>
        <span class="follow"><em class="fa fa-twitter"></em> <?php echo $companyDetails['twitter'];?></span>
        <?php } ?>
        <?php 	if (!empty($companyDetails['facebook'])) { 	?>
        <span class="follow"><em class="fa fa-facebook"></em> <?php echo $companyDetails['facebook'];?></span>
        <?php } ?>
        <?php 	if (!empty($companyDetails['google_plus'])) { 	?>
        <span class="follow"><em class="fa fa-google-plus"></em> <?php echo $companyDetails['google_plus'];?></span>
        <?php } ?>
      </div>
    </div>
    <div class="col-md-6 mar-20 no_pad_l"> <span class="phone"><em class="fa fa-phone"></em>1800 103 0003</span><br>
      <?php 	if (!empty($companyDetails['website'])) { 	?>
      <span class="web"><em class="fa fa-globe"></em><?php echo $companyDetails['website'];?></span><br>
      <?php } ?>
      <?php 	if (!empty($companyDetails['email'])) { 	?>
      <span class="mail"> <em class="fa fa-envelope"></em><?php echo $companyDetails['email'];?></span><br>
      <?php } ?>
      <?php 	if (!empty($companyDetails['sms'])) { 	?>
      <span class="phone"><em class="fa fa-envelope-o"></em><?php echo $companyDetails['sms'];?></span>
      <?php } ?>
    </div>
  </div>
  <?php 
  ...
  <div class="company_abt claim_r">
    <h3 class="t_cmp_header"> <span>Claims ratio of <?php echo $companyDetails['company_display_name'];?></span> </h3>
    <table class="mar-20">
      <thead>
        <tr>
          <th>Years</th>
      ...
      <div class="col-md-6" style="padding-left: 0px;">
        <div class="art_cnt widget ">
          ...
          <div class="textwidget">
            <p> <img style="border: 0px none;" alt=""
								src="assets/images/art1.jpg">At any moment, an unhappy
              customer can share their opinion with the masses through...How
              to speak with an Indian Accent. </p>
          </div>
          <div class="comnt"> <span class="text-left l">1,348 views</span> <span
							class="text-right r">0 comments</span> </div>
        </div>
        <div class="art_cnt widget ">
          <h4 class="sub_h" style="margin-top: 0px;">How to secure your
            future with pension</h4>
    ...
    <div class="col-md-12 mar-25 no_pad_lr">
      ...
      <div class="col-md-4" style="padding-left: 0px;">
        <div class="art_cnt widget video">
          <div class="textwidget"> <a href="http://www.youtube.com/watch?v=zkdv8Plk58Q"
							target="_blank"><img
							src="http://img.youtube.com/vi/zkdv8Plk58Q/0.jpg"
							class="img_t" style="max-width: 94%;" border="0"> </a> </div>
          <div class="comnt">
      ...
      <div class="col-md-4 ">
        <div class="art_cnt widget video">
          <div class="textwidget"> <a href="http://www.youtube.com/watch?v=lUxY6sx6U9s"
							target="_blank"><img
							src="http://img.youtube.com/vi/lUxY6sx6U9s/0.jpg"
							class="img_t" style="max-width: 100%;" border="0"> </a> </div>
          <div class="comnt">
            <p>I have been sold 7 ulip policies</p>
          </div>
        </div>
      ...
      <div class="col-md-4 ">
        <div class="art_cnt widget video">
          <div class="textwidget"> <a href="http://www.youtube.com/watch?v=kOhdPbf7p3M"
							target="_blank"><img
      ...
      <div class="col-md-12 text-rightp"> <a href="javascript:void(0)">More Videos <span class="ic">+</span> </a> </div>
    </div>
  </div>
</div>
