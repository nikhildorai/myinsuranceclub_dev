...
{
	$guides = $guidesDetails['guides'];
	$author = $guidesDetails['author'];
	//$tag = $guidesDetails['tag'];	
	$url = base_url().'guides/'.$guides['guides_slug'];

	$folderUrl = $this->config->config['folder_path']['guides']['main_image'];
	$fileUrl = $this->config->config['url_path']['guides']['main_image'];
	$imgUrl = "";
	
	if (isset($guides['main_image']) && !empty($guides['main_image']))
	{
		if (file_exists($folderUrl.$guides['main_image']))
		{
			$imgUrl = $fileUrl.$guides['main_image'];
		}
	}
	?>
      <div id="primary" class="content-area col-md-8 ">
        <guide id="" class="clearfix" >
          <div id="" class="site-content" role="main">
            <header class="entry-header clearfix">
              <h1 class="entry-title" itemprop="name"><?php echo $guides['title'];?></h1>
              <div class="entry-meta clearfix">
              
               <span class="meta-date updated"><i class="fa fa-clock-o"></i><?php echo $this->util->getDate($guides['publish_date'],9)?> </span><!-- .meta-date --> 
               
                
                <span class="meta-views" title="Views"> <i class="fa fa-eye"></i><?php echo $guides['page_view_count'] + 1;?>&nbsp;views </span><!-- /meta-views --> 
              
                
                <span class="meta-author"> <i class="fa fa-user" title="Author"></i> <span class="author vcard"><a class="url fn n" href="<?php echo base_url().'guides/author/'.$author['uacc_username'];?>" title="" rel="author"> <?php echo $author['upro_first_name']; echo isset($author['upro_last_name']) ? ' '.$author['upro_last_name'] : '';?> </a></span> </span><!-- .meta-author --> 
...
<div class='shareaholic-canvas' data-app='share_buttons' data-app-id='7396778'></div>-->
            ...
            <!-- Post Thumbnail -->
       <?php if (!empty($imgUrl)){?>     
            <div class="entry-thumb"> <img src="<?php echo $imgUrl;?>" alt="<?php echo $guides['title'];?>" title="<?php echo $guides['title'];?>" style="width:100%;height:100%;"> </div>
      <?php }?>      
            <!-- .entry-thumb -->
            
            <div class="entry-content clearfix" itemprop="guideBody">
<?php
				$description = array(); 
				if (!empty($guides['description']))
					$description = explode('###', $guides['description']);
				if (!empty($description))
				{
					echo reset($description);
				}				
				if (!empty($guides['tweet_property']))
				{
?>
						<div class="tw_sh">
							...
							<div style="width: auto; max-width: 92%; float: left; position: relative;">
								<div class="twt">
									<span><?php echo $guides['tweet_property'];?></span>
          ...
          <!--  <footer class="entry-meta clearfix"><span class="tag-links meta-tags"><i class="fa fa-paperclip" title="Tags"></i> <span class="tags-title">Tags:</span>
              ...
              <div class="author-description clearfix">
                <div class="ct-athr-left">
                  <p>Hi, my name is  <strong><?php echo $author['upro_first_name']; echo isset($author['upro_last_name']) ? ' '.$author['upro_last_name'] : '';?></strong>. <?php echo $author['upro_about'];?>.<br/>
                    <br/>
                     <a class="author-site sm-italic-gray" href="<?php echo base_url().'guides/author/'.$author['uacc_username'];?>">View my other posts</a> 
                    </p>
            ...
            <div class="col-md-6 no_pad_lr"><h3>Did you find this guides useful?</h3>
...
*/ ?>        
		...
		<div data-za-events="click" class="rating-widget-stars left" id="ratingDivParent">
			<div data-rating="0" data-originalclass="user_starssel_0" class="rating-cls user_starssel_0">
				...
				<div class="tot_votes">
					<div class="avg_vote">
						<span id="ratingValueId"><?php echo (!empty($guides['rating_value']) && $guides['rating_value'] != 0) ? number_format($guides['rating_value'], 1) : 0;?></span><span class="sm">/5</span>
					</div>
					<div class="tot_votes_m">based on <?php echo $guides['rating_click_count'];?> Votes</div>
				</div> 
            </div>
...
<script>(function(d, s, id) {
  ...
  fjs.parentNode.insertBefore(js, fjs);
            ...
            <div class="fb-like" data-href="http://www.myinsuranceclub.com/guides/" data-layout="box_count" data-action="like" data-show-faces="false" data-share="false"></div>
            </div>
            
            <div class="tw_cnt col-md-3">
                <a href="https://twitter.com/share" class="twitter-share-button" data-url="http://www.myinsuranceclub.com/guides/" data-via="your_screen_name" data-lang="en" data-related="anywhereTheJavascriptAPI" data-count="vertical">Tweet</a>
...
<script type="IN/Share" data-url="http://www.myinsuranceclub.com/guides/" data-counter="top"></script>
            </div>
            
            
            <div class="gp_cnt col-md-3">
            <!-- Place this tag where you want the +1 button to render. -->
<div class="g-plusone" data-size="tall" data-href="http://www.myinsuranceclub.com/guides/"></div>
    ...
    var s = document.getElementsByTagName('script')[0]; s.parentNode.insertBefore(po, s);
		...
		<?php 			
						...
						{	
							if ($i < 6)
							{	?>
							<li><a href="<?php echo base_url().'guides/'.$v1['slug'];?>">- <?php echo $v1['title'];?></a></li>
<?php 						}
							$i++;
						}	?>
						</ul>
				...
				<div class="entry-comments clearfix"
					...
					<div id="" class="comments-area">
						<div id="" class="comment-respond">
							...
							$arrParams['disqus_title'] = $guides['slug'];
...
var record = "<?php echo $guides['guides_slug'];?>";
var ratingType = "guides";
