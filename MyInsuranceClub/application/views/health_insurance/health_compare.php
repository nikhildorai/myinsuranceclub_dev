				...
				<div class="header-inner container">
					<div class="row">
						<div class="col-md-12">
							...
							<div class="slogan col-md-8">India's 1st IRDA Approved Comparison
								Site</div>
						</div>
					</div>
				</div>
							...
							<ul class="nav navbar-nav" id="menu">
								...
								<li><a href="#" class="dropdown-toggle menu-item"
									id="features-drop" data-toggle="dropdown" data-hover="dropdown">Life
										Insurance</a> <!-- Dropdown Menu - Mega Menu -->
									<ul class="dropdown-menu mega-menu" role="menu"
										aria-labelledby="features-drop">
										<li class="col-md-4"><a role="menuitem" href="#" tabindex="-1"
											class="menu-item"><strong>Term Plans</strong></a></li>
										<li class="col-md-4"><a role="menuitem" href="#" tabindex="-1"
											class="menu-item"><strong>Endowment Plans</strong></a></li>
										<li class="col-md-4"><a role="menuitem" href="#" tabindex="-1"
											class="menu-item"><strong>Child Plans</strong></a></li>
										<li class="col-md-4"><a role="menuitem" href="#" tabindex="-1"
											class="menu-item"><strong>ULIP</strong></a></li>
										<li class="col-md-4"><a role="menuitem" href="#" tabindex="-1"
											class="menu-item"><strong>Money Back Plans</strong></a></li>
										<li class="col-md-4"><a role="menuitem" href="#" tabindex="-1"
											class="menu-item"><strong>Pension Plans</strong></a></li></li>
							</ul>
							</li>
							<li><a href="#" class=" menu-item">Travel Insurance</a></li>
							<li><a href="#" class="dropdown-toggl last"
								data-toggle="dropdown" data-hover="dropdown">Others</a>
								<ul class="dropdown-menu mega-menu other" role="menu"
									aria-labelledby="features-drop">

									<li class="col-md-4"><a role="menuitem" href="#" tabindex="-1"
										class="menu-item"><strong>Money Back Plans</strong></a></li>
									<li class="col-md-4"><a role="menuitem" href="#" tabindex="-1"
										class="menu-item"><strong>Pension Plans</strong></a></li>
									<li class="col-md-4"><a role="menuitem" href="#" tabindex="-1"
										class="menu-item"><strong>Endowment Plans</strong></a></li>
			...
			<p class="displayStaticRange clearFix"
								...
								<p class="addOnFilter">
									<label for="1_1_refundable"> <input type="checkbox"
										class="search_filter" id="room_rent" name="room_rent"
										value="1"> Show plans without room rent caps
									</label>
								</p>
								<p class="addOnFilter" style="margin: 0px; padding: 0px;">
								...
								<p class="addOnFilter">
									...
									<label for="1_1_refundable"> <input type="checkbox"
										...
										value="1"> Show plans with maternity benefits
									</label>
								</p>
			...
			<div class="bottom-content-padding">
				<div id="bottom_2" class="one_fourth">
					<div class="column-content-wrapper">
						<div
							class="bottom-col-content widget_recent_entries custom-formatting">
						...
						<div
							class="bottom-col-content widget_recent_entries custom-formatting">
							<h3 class="bottom-col-title" style="margin-bottom: 11px;">Connect
								with Us</h3>
							<ul>
              ...
              <div style="margin-top:10px; color:#3d6e97; font-style:italic; font-size:13px;"> Email: contact@myinsuranceclub.com</div>
						...
						<div
							...
							<ul>
								...
								<li><a href="mailto:contact@myinsuranceclub.com">Email:
										contact@myinsuranceclub.com</a></li>
				...
				<div id="bottom_4" class="one_fourth last_column">
					<div class="column-content-wrapper">
						<div
							class="bottom-col-content widget_text substitute_widget_class">
							<h3 class="bottom-col-title"
								style="background: none; margin-top: 10px;"></h3>
							<p class="border-box-f">
								<img src="<?php echo base_url();?>assets/images/irda_logo.jpg"
									border="0">
							</p>
							<div class="textwidget small">
								<strong>Important</strong>: Insurance is the subject matter of
								solicitation
							</div>
					...
					<div class="col-md-4">
						<ul class="list-inline footer-menu">
							...
							<li><a href="https://twitter.com/share"
								...
								data-url="https://twitter.com/MyInsuranceClub"
								data-via="MyInsuranceClub" data-lang="en">Tweet</a> <script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="https://platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script></li>
