...
<div class="cmp_tbl">
  <div class="cus_tb clearfix">
    <div class="col-md-2 pad-right-10 logo_ins">
      <div class="img_bx"> <img src="<?php echo $fileUrl.$detail['logo_image_2'];?>" border="0"
					class="img_bx_i">
        <div class="check_bx">
          <div class="checkbox">
            <label>
            <input type="checkbox" name="compare[]" id="c_name_<?php echo $detail ['variant_id'].$detail['annual_premium'];?>"
							class="cmpplans" value="<?php echo $compare_data?>" <?php echo $plan_checked; ?>>
            <label
    ...
    <div class="col-md-3 pad-left-10">
      <div class="c_t"> <span class="title_c" style="width: 100%;"><?php echo $detail['company_shortname']?></span><span
					class="sub_tit"><?php echo $detail['policy_name'].$variant?></span> </div>
    </div>
    <div class="col-md-7 m_anc">
      ...
      <div class="col-md-4 post_msg" id="buy_now_message_<?php echo $detail['variant_id'];?>" style="display:none"> Call 100100100 to buy this policy </div>
      <div class="col-md-4 pad_r_10" id="buy_now_btn_<?php echo $detail['variant_id'];?>"> <a class="btn_offer_block" href="#" onclick="return buy_now_msg(<?php echo $detail['variant_id']?>,<?php echo $detail['policy_id'];?>);">Buy Now <i
          ...
          <table width="100%">
            <tbody>
              <tr class="odd">
                ...
                <td class="cus_width"><?php echo $detail['cashless_treatment'] ?></td>
              </tr>
              <tr>
                <td>Pre-existing diseases</td>
                <td class="cus_width"><?php echo $preexist_diseases?></td>
              </tr>
              <tr class="odd">
                <td>Auto recharge of Sum Insured</td>
                <td class="cus_width"><?php echo $detail['autorecharge_SI']?></td>
              </tr>
              <tr>
                ...
                <td class="cus_width"><ul class="no">
        ...
        <div class="cus_d" style="padding: 5px;">
          <div style="float: left; width: 100%; margin-top: 10px;">
            ...
            <div class="loc_d hos"
              ...
              <div class="col-md-12"> <span class="tt-dropdown-menu"
