...
<div id="highlighted" style="background:#fff; padding-bottom:50px; margin-bottom:0px;" >
  <div class="container">
    <h2 class="title-divider"> <span>HDFC Life Click 2 Protect Term Plan</span> </h2>
    <div class="row">
      <div class="col-md-9" style="padding-right:0px;">
        <div class="top_col border-box-1 radius2" style="min-height:515px;">
          <header class="share-header">
            <aside class="shares social">
              <div class="total-shares" data-index="0"> <em>22,247</em>
                <div class="caption">Views</div>
              </div>
              <div class="total-shares" data-index="0"> <em>424</em>
                <div class="caption">Comments</div>
              </div>
              <div class="share-buttons v2">
                <div class="share-container">
                  <div class="share-count">2.5k</div>
                  <div class="primary-shares"> <a class="social-share facebook fa fa-facebook-square"> <span class="expanded-text">Share on Facebook</span> </a> <a class="social-share twitter fa fa-twitter"> <span class="alt-text">Tweet</span> <span class="expanded-text">Share on Twitter</span> </a>
                    <div class="share-toggle fa fa-plus"></div>
                  </div>
                  <div class="secondary-shares"> <a class="social-share google_plus fa fa-google-plus" ></a> <a class="social-share linked_in fa fa-linkedin-square"></a>
          ...
          <div class="col-md-12">
            <div class="col-md-5 no_pad_l">
              <div class="logo_pages border-box-1 radius2"> <img src="assets/images/logo/c2phead.png" border="0"> </div>
            ...
            <a href="#" onclick="return clickTab('#tab-reviews')">Add Your Comment</a>
              ...
              <p class="availability in-stock"><span class="p-icons"><i class="fa fa-check"></i> </span>Pure term plan</p>
              <p class="availability in-stock"><span class="p-icons"><i class="fa fa-check"></i></span>High life cover at affordable premium</p>
              <p class="availability in-stock"><span class="p-icons"><i class="fa fa-check"></i></span>Premium paying term is same as policy term</p>
              <p class="availability in-stock"><span class="p-icons"><i class="fa fa-check"></i></span>Claim settlement ratio of 96%</p>
              <div class="short-description">
                <h2>Quick Overview</h2>
                <div class="std">HDFC Life Click2Protect, an online term insurance plan that offers a 
                  quick and simple solution at the click of a button to safeguard 
                  the financial independence of your entire family. The plan 
                  takes care of family's financial needs in case of uncertainties by 
                  providing a lump sum to the family.</div>
              </div>
            </div>
            <div class="tw_sh">
              <div  style="width:50px;; float:left;"> <a class="feature-icon-hover " href="javascript:void(0)" title="Tweet This"> <span class="v-center"> <span class="icon i-recommend-bw icon-color-productview fa fa-thumbs-up"></span> </span> </a> </div>
              <div  style="width:auto;max-width:92%; float:left; position:relative;">
                <div class="twt"> <span>HDFC Life Insurance has the 3rd highest Claims Ratio among Life Insurers @ 96.34%</span><span class="tw_th">Tweet This</span> </div>
                <div class="twt_img"><img src="assets/images/twt_share.png" border="0"></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="col-md-3 sidebar sidebar-right">
        <div class="inner">
          <div class="block"> <img src="assets/images/ad/hdfc.jpg" style="max-width:100%;" border="0"> </div>
          <div class="block"> <img src="assets/images/ad/hdfc.jpg"style="max-width:100%;" border="0"> </div>
        </div>
      </div>
    </div>
...
">&#8377;8,400</span></h3>
            ...
            <div class="plan  col-sm-3">
              <h3>Age = 45 Years<span>&#8377;6,200</span></h3>
              <ul>
              </ul>
            </div>
            <div class="plan  col-sm-3">
              <h3>Age = 55 Years<span>&#8377;7,100</span></h3>
              <ul>
              </ul>
            </div>
            <div class="cal"><a href="javascript:void(0)" class="btn_offer_block">Calculate Your Premium <i class="fa fa-angle-right"></i></a></div>
          </div>
        </div>
      </div>
    </div>
    <div class="row usp">
      <div class="col-sm-12">
        <h2 class="lined-heading"><span>Benefits & Features</span></h2>
      </div>
      <div class="col-sm-3 bounceIn appear animated" data-start="0">
        <div class="box-icon">
          <div class="circle"><i class="fa fa-umbrella fa-2x"></i></div>
          <h3>Death Benefit</h3>
      ...
      <div class="col-sm-3 bounceIn appear animated" data-start="400">
        <div class="box-icon">
          <div class="circle"><i class="fa fa-clock-o fa-2x"></i></div>
      ...
      <div class="col-sm-3 bounceIn appear animated" data-start="800">
        <div class="box-icon">
          <div class="circle"><i class="fa fa-suitcase fa-2x"></i></div>
      ...
      <div class="col-sm-3 bounceIn appear animated" data-start="1200">
        <div class="box-icon">
          <div class="circle"><i class="fa fa-thumbs-up fa-2x"></i></div>
          <h3>Tax Benefit</h3>
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse interdum eleifend augue, quis rhoncus purus fermentum. </p>
        </div>
      </div>
    ...
    <div class="row pad">
      <div class="col-sm-12">
        <h2 class="lined-heading"><span>Eligibility Conditions</span></h2>
      </div>
    ...
    <div class="row pad">
      <div class="col-sm-12">
        <h2 class="lined-heading"><span>Riders</span></h2>
      </div>
      <table cellspacing="0"  class="eligibility">
        <tr>
    ...
    <div class="row pad">
      <div class="col-sm-12">
        <h2 class="lined-heading one_time" id="ad_show_claim"><span>Additional Details</span></h2>
      </div>
    ...
    <div class="row pad" id="thisdiv">
      <div class="col-sm-12">
        <h2 class="lined-heading"><span>Peer Comparison</span></h2>
      </div>
      <div class="col-sm-12">
        <div class="wid_25">
...
-->      <div class="col-sm-12 clearfix count_shw" id="">
    ...
    width: 600px;">
      ...
      <div class="col-sm-3 text-center"><img src="assets/images/brch_2.jpg" border="0"></div>
