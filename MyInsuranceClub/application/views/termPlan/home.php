...
<div id="highlighted" style=" background:#f9f9f9; padding-bottom:50px; margin-bottom:0px;" >
  <div class="container">
	...
	<?php echo form_open('life_insurance/termPlan/get_termPlan_results',array('name'=>'health_form'));?>
  <div class="col-md-12 center mar-20"><h1>Compare & Buy Term Insurance Plans</h1>
 ...
 <div data-bind="" style="display: none;" class="choice" id="c_ch">
               <div class="choice-leftcol" data-bind="">
                    <ul class="years active" id="c_amt" data-bind="jScrollPane">
                            ...
                            <li data-cvg-id = "<?php echo $k;?>"><a href="javascript:void(0);"><?php  {echo $v;} ?></a></li>
                            <?php } ?>
                    </ul>
           ...
           </div> cover for <span id="clickk_p"><span class="dotted c_for" id="yr">
            
            <?php if(isset($this->session->userdata['user_input']['plan_type_name'])){ echo $this->session->userdata['user_input']['plan_type_name'];}else{?>5 years<?php }?></span>
 
 <div data-bind="" style="display: none;" class="choice f" id="c_yr">
               <div class="choice-leftcol" data-bind="">
                    <ul class="years active" id="c_term" data-bind="jScrollPane">
                           <?php foreach($term_in_years as $k=>$v){?> 
                           <li data-term-id="<?php echo $k; ?>"><a href="javascript:void(0);"><?php echo $v; ?></a></li>
                           <?php } ?>
                    </ul>
                    <div class="stepwrap years-stepwrap">
                        <span class="step show">
                            <em>2</em>
                            <span class="label-mid">Duration Of Policy</span>
                        </span>
                    </div>
                </div>
 ...
 <div data-bind="" style="display: none;" class="choice l" id="c_ch_l">
  ...
  <div class="col-md-12" style="margin-left:285px;margin-top:30px;">
  <p>About Policy holder:</p>
  </div>
   <div class="col-md-12 center" style="margin-left:280px">
   <div class="form-group col-md-2" style="padding-left:5px;">
                    ...
                    <input type="hidden" id="cust_gender" name="cust_gender" value="<?php //if(isset($this->session->userdata['user_input']['cust_gender']))
                    																					...
                    																					//}else 
                    																					//{?>male<?php //}?>">
                    <input type="hidden" id="policy_term" name="policy_term" value="5">
                    <input type="hidden" id="cust_city" name="cust_city" value="<?php //if(isset($this->session->userdata['user_input']['cust_city']))
                    																					...
                    																					//}else 
                    																					//{?>590<?php //}?>">
                     <input type="hidden" id="cust_city_name" name="cust_city_name" value="Mumbai">
                    ...
                    <input type="hidden" id="coverage_amount_literal" name="coverage_amount_literal" value="">	
                    ...
                    <input type="text" data-provide="datepicker" class="form-control" id="cust_dob" name="cust_dob" value="" placeholder="Date Of Birth">
                  </div>
                  <div class="form-group col-md-2">
              			<label class="sr-only" for="signup-first-name">Tobacco</label>
                    	<span style="background-color:#FFF" class="input-group-addon form-control">Tobacco |
                    	<input type="radio" id="smoker" name="smoker" value="1">yes
                 ...
                 <div class="col-md-12 center" style="margin-left:280px;">
                  <!-- div class="form-group col-md-2" style="padding-left:5px;">
                    <label class="sr-only" for="signup-first-name">Annual Income</label>
                    <input type="text" class="form-control" id="annual_income" name="annual_income" value="" placeholder="Annual Income">
                  </div> -->
                  
                     <div class="form-group col-md-2" style="padding-left:5px;">
                    <label class="sr-only" for="signup-first-name">Mobile</label>
                    <input type="text" class="form-control" id="cust_mobile" name="cust_mobile" value="" placeholder="Mobile">
                  </div>
                  
                  
                   <div class="form-group col-md-2">
                    <label class="sr-only" for="signup-first-name">Email</label>
                    <input type="text" class="form-control" id="cust_email" name="cust_email" value="" placeholder="Email">
                  </div>
                 
   </div>
   
   
    <div class="col-md-12" style="margin-left:285px;">
    ...
    <div class="checkbox">
                  ...
                  <div id="loader" style="display: none;"><img src="<?php echo base_url().'images/loading.gif'?>" ></div> 
                  </div>
                  </div>
