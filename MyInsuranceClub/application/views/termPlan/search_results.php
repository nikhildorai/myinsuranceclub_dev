		...
		<div class="container">
			<div class="row" style="margin-top: 40px;">
                ...
                <h6 class="fh3" style="border: none;">
								...
								plan that meets your search </span> <?php echo nbs(50);?><span><a
					...
					<?php echo form_open('life_insurance/termPlan/compare_policies',array('id'=>'compare'));?>
						<div
						...
						<?php echo $this->util->getUserSearchFiltersHtml($customer_details, $type = "termplan");?>
				...
				<div class="col-md-3 col-md-pull-9 sidebar sidebar-left">
					<div class="inner" style="margin-bottom: 50px;">
						...
						<div class="block">
							<h6 class="fh3 c">
								<a href="<?php echo site_url('life_insurance/termPlan');?>">&lt;
						...
						<div class="block1">
							...
							<div class="filterContent ">
								...
								<?php echo form_open('life_insurance/termPlan',array('id'=>'search'));?>
	...
	<script>
		...
		app.controller('DemoController',
        	function DemoController($scope) {
        		...
        		$scope.demo2 = {
					range: {
						min:<?php echo count($customer_details);?>,
						max: <?php echo count($customer_details);?>
					},
					minPrice: <?php echo count($customer_details);?>,
					maxPrice: <?php echo count($customer_details);?>
...
(function($) {
	$(document).ready(function() {
		...
		$('#comparePolicy').on('click',function(){
			if(!($('.term_check:checked').length>1))
			{
				alert('Please Select At Least 2 Plans To Compare.');
				return false;
			}
			else if ($('.term_check:checked').length>3)
			{
	...
	$('.search_filter').on('click',function(){
		data = $('#search').serialize();
		 ...
		 $.ajax({
			type:"post", 
			url:"<?php echo base_url().'index.php/life_insurance/termPlan/get_term_plan_results'?>",
			data:data,
