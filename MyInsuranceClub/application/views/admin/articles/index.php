                ...
                <accordion-group heading="Search Filter" is-open="<?php echo $open;?>">
					<?php echo form_open('admin/articles/index', array('method'=>'get'));	?>
				        <div class="form-group">
		                    ...
		                    <div class="col-sm-10">
		                        <input type="text" class="form-control" placeholder="Search by articles name"  id="title" name="title" value="<?php echo array_key_exists( 'title',$search_query) ? $search_query['title'] : '';?>" >
	                    	</div>
		                </div>
					...
					if (!empty($records))
					{
						if ($records->num_rows() > 0)
						{
						   ...
						   //		{
									...
									{
										$actionBtn .= '<a href="'.$base_url.'admin/articles/create/'.$row['article_id'].'">Update</a>';
									//	$actionBtn .= ' | <a href="'.$base_url.'admin/articles/changeStatus/'.$row['article_id'].'/inactive">Inactive</a>';
									}
									else if ($row['status'] == 'inactive')
									{
										$actionBtn .= '<a href="'.$base_url.'admin/articles/create/'.$row['article_id'].'">View</a>';
									}
