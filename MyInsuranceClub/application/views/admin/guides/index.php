...
<?php 	if (! empty($message))
    ...
    <section class="panel panel-primary">
        <div class="panel-heading">
        	<strong>
        		<span class="glyphicon glyphicon-th"></span> Manage guides 
        	</strong>
        	<a href="<?php echo $base_url;?>admin/guides/create" class="btn btn-w-md btn-gap-v btn-success btn-sm" style="float: right; margin-top: -5px;">Create New Guide</a>
        </div>
        ...
        <section class="panel" data-ng-controller="AccordionDemoCtrl"  style="border-bottom-width: 0px;">
            ...
            ?>
                <accordion-group heading="Search Filter" is-open="<?php echo $open;?>">
					<?php echo form_open('admin/guides/index', array('method'=>'get'));	?>
				        <div class="form-group">
		                    <label for="" class="col-sm-2">Title</label>
		                    <div class="col-sm-10">
		                        <input type="text" class="form-control" placeholder="Search by guides name"  id="title" name="title" value="<?php echo array_key_exists( 'title',$search_query) ? $search_query['title'] : '';?>" >
	                    	</div>
		                </div>
				        ...
				        <div class="form-group">
							...
							<input
								...
								<a href="<?php echo $base_url; ?>admin/guides"  class="btn btn-w-md btn-gap-v btn-default">Reset</a>
	                    	</div>
		                </div>
					<?php echo form_close();?>
                </accordion-group>
					...
					if (!empty($records))
					{
						if ($records->num_rows() > 0)
						{
						   ...
						   //		{
									...
									{
										$actionBtn .= '<a href="'.$base_url.'admin/guides/create/'.$row['guide_id'].'">Update</a>';
									//	$actionBtn .= ' | <a href="'.$base_url.'admin/guides/changeStatus/'.$row['guide_id'].'/inactive">Inactive</a>';
									}
									else if ($row['status'] == 'inactive')
									{
										$actionBtn .= '<a href="'.$base_url.'admin/guides/create/'.$row['guide_id'].'">View</a>';
									}
