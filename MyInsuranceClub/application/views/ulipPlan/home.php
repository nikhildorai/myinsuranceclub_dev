  ...
  <div id="highlighted "  class="" >
    ...
    <div class="container">
      <div class="col-md-12 center ">
        ...
        <h1 class="term_container" style="text-align:left; margin-top:30px;" id="step1">Compare & Buy ULIPs Insurance Plans</h1>
        <div class="col-md-12">
        ...
        <div class="col-md-12">
          <p class="term_container sc_top" style="text-align:left; padding-top:0px; padding-bottom:10px; color:#ff6633;">Want the best ULIPs insurance plan? Get Started...</p>
        </div>
               ...
               <div class="form-lable f_big">Policy Details</div>
                <div class="mic_type mic_section">
                 ...
                 <div class="" style="margin-top:0px;">
                  <div class="form-lable t">Annual Premium you wish to pay?</div>
...
<script src="<?php echo base_url();?>/assets/js/ulip.js"></script>