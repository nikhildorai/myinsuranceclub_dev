...
<div id="highlighted "  class="" > 
  <div class="container">
    <div class="col-md-12 center ">
      ...
      <h1 class="life_container" style="text-align:left; margin-top:30px;" id="step1">Compare & Buy Life Insurance Plans</h1>
      <div class="col-md-12">
        <p class="life_container" style="text-align:left; padding-top:10px; padding-bottom:25px;">Select a plan that best suits your needs</p>
    ...
    <div class="life_container">
      ...
      <div class="one_third_l">
      	<div class="l_c">
      		...
      		<div class="l_h">Term Insurance Plans</div>
      	</div>
      
      	<div class="l_s">
        	<p class="l_s_p">Get high covers at extremely low premiums.</p>
     ...
     <div class="one_third_l">
      	<div class="l_c">
      		...
      		<div class="l_h">Child Plans</div>
      	</div>
      
      	<div class="l_s">
        	<p class="l_s_p">Protect your child's future with custom plans.</p>
      ...
      <div class="one_third_l no_ri8">
      	...
      	<div class="l_c">
      		<div class="l_icon"><img src="<?php echo base_url();?>/assets/images/life/3.png" border="0"></div>
      		<div class="l_h">Pension Plans</div>
      	</div>
      
      	<div class="l_s">
        	<p class="l_s_p">Save for retirment days. Don't depend on others.</p>
            <p class="l_s_p_it">An absolute must for those who with dependents</p>
      	</div>
      ...
      <div class="one_third_l">
      	<div class="l_c">
      		...
      		<div class="l_h">Endowment Plans</div>
      	</div>
      
      	<div class="l_s">
        	<p class="l_s_p">Grow your money with stable returns & tax benefits..</p>
            <p class="l_s_p_it">An absolute must for those who with dependents</p>
      	</div>
     ...
     <div class="one_third_l">
      	<div class="l_c">
      		...
      		<div class="l_h">Money Back Plans</div>
      	</div>
      
      	<div class="l_s">
        	<p class="l_s_p">Get money at regular intervals & save tax.</p>
            <p class="l_s_p_it">An absolute must for those who with dependents</p>
      	</div>
      ...
      <div class="one_third_l no_ri8">
      	...
      	<div class="l_c">
      		<div class="l_icon"><img src="<?php echo base_url();?>/assets/images/life/6.png" border="0"></div>
      		<div class="l_h">ULIPs <span>- Unit Linked Insurance Plans</span></div>
      	</div>
      
      	<div class="l_s">
        	<p class="l_s_p">Grow your money + get insurance  cover.</p>
            <p class="l_s_p_it">An absolute must for those who with dependents</p>
      	</div>
