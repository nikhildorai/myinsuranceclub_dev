...
class Auth_admin extends Admin_Controller {
	...
	*/
    ...
    function dashboard()
    {
		...
		$this->template->write_view('content', 'admin/admin_functions/dashboard_view', $this->data, TRUE);
		$this->template->render();
		//$this->load->view('demo/admin_functions/dashboard_view', $this->data);
	}
    ...
    function manage_user_groups()
    {
		...
		$this->load->view('demo/admin_functions/user_groups_view', $this->data);		
    }
	...
	function insert_user_group()
	{
		...
		$this->load->view('demo/admin_functions/user_group_insert_view', $this->data);
	}
	...
	function update_user_group($group_id)
	{
		...
		$this->load->view('demo/admin_functions/user_group_update_view', $this->data);
	}
    ...
    function manage_privileges()
    {
		...
		$this->load->view('demo/admin_functions/privileges_view', $this->data);
	}
	...
	function insert_privilege()
	{
		...
		$this->load->view('demo/admin_functions/privilege_insert_view', $this->data);
	}
	...
	function update_privilege($privilege_id)
	{
		...
		$this->load->view('demo/admin_functions/privilege_update_view', $this->data);
	}
    ...
    function update_user_privileges($user_id)
    {
		...
		$this->load->view('demo/admin_functions/user_privileges_update_view', $this->data);		
    }
    ...
    function update_group_privileges($group_id)
    {
		...
		$this->load->view('demo/admin_functions/user_group_privileges_update_view', $this->data);		
    }
	...
	function list_user_status($status = FALSE)
	{
		...
		$this->load->view('demo/admin_functions/users_view', $this->data);
	}
	...
	function delete_unactivated_users()
	{
		...
		$this->load->view('demo/admin_functions/users_unactivated_view', $this->data);
	}
