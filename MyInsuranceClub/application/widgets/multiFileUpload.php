...
?>    	
        ...
        <script  type="text/javascript" src="<?php echo base_url(); ?>assets/js/fileupload/file.bootstrap.min.js" ></script>
        ...
        <script  type="text/javascript" src="<?php echo base_url(); ?>assets/js/fileupload/main.js" ></script>
                    ...
                    <div id="new-article">
                        ...
                        <div id="upload-img">
                            ...
                            <form id="fileupload" action="<? echo base_url() . 'multiFileUpload/upload_img'; ?>" method="POST" enctype="multipart/form-data">
