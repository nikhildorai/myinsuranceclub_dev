                ...
                controller: ["$scope", "$element", "$location",
                    function ($scope, $element, $location) {
                        ...
                        return path = function () {
                        	...
                        	//	edit by krishna
                        	var requestUri = location.pathname; //get current url path
                        	var reqArray = requestUri.split('/'); //explode
                        	reqArray = $.grep(reqArray,function(n){ return(n) }); // remove the empty values
                        	path = reqArray[reqArray.length-1]; // get last value in array
                        	//	edit end
                            ...
                            case "login":
                            case "admin":
                            case "manual_reset_forgotten_password":
        ...
        .controller("AppCtrl", ["$scope", "$location",
            function ($scope, $location) {
                return $scope.isSpecificPage = function () {
                    var path;
                    console.log($location.path(), _.contains(["/404", "/pages/500", "/pages/login", "/pages/signin", "/pages/signin1", "/pages/signin2", "/pages/signup", "/pages/signup1", "/pages/signup2", "/pages/lock-screen"], path));
