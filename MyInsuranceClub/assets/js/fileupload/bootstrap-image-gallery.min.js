(function (a) {
	...
	a.extend(a.fn.modal.Constructor.prototype, {
		...
		toggleSlideShow: function () {
			...
			this.options.slideshow ? (this.options.slideshow = 0, this.stopSlideShow()) : (this.options.slideshow = a.data("slideshow") || 5e3, this.startSlideShow()), a.children().toggleClass("icon-play icon-pause")
		},
		...
		showImage: function (b) {
			...
			f.css({
				width: b.width,
				height: b.height
			}), d && (g = c.clone().hide().appendTo(document.body)), e.call(c.stop(), {
